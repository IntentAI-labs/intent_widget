export const createTokenABI = [
    {
        ...
        "interface_name": "pay_strk::pay_strk::IAtomicStarkFactory"
    },
    {
        "type": "struct",
    ...
    {
        "type": "interface",
        "name": "pay_strk::pay_strk::IAtomicStarkFactory",
        "items": [
            {
                "type": "function",
                "name": "create_ERC20",
    ...
    {
        "type": "event",
        "name": "pay_strk::pay_strk::AtomicStarkFactory::Event",
        "kind": "enum",
        "variants": []
    }
]
...
export const intentAbi = [
    {
        "type": "impl",
        "name": "IntentContent",
        "interface_name": "IntentContent::IntentContent::IIntentContent"
    },
    {
        "type": "struct",
        "name": "core::byte_array::ByteArray",
    ...
    {
        "type": "interface",
        "name": "IntentContent::IntentContent::IIntentContent",
        "items": [
            {
                "type": "function",
                "name": "get_info_by_id",
                ...
                "outputs": [
                    {
                        "type": "(core::integer::u32, core::byte_array::ByteArray, core::byte_array::ByteArray, core::starknet::contract_address::ContractAddress)"
                    }
                ],
                "state_mutability": "view"
            },
    ...
    {
        "type": "event",
        "name": "IntentContent::IntentContent::IntentContent::Event",
        "kind": "enum",
        "variants": []
    }
]

export const iframeAbi = [
    {
        "type": "impl",
        "name": "IntentIframe",
        "interface_name": "IntentInframe::IntentInframe::IIntentIframe"
    },
    {
        "type": "struct",
        "name": "core::byte_array::ByteArray",
    ...
    {
        "type": "interface",
        "name": "IntentInframe::IntentInframe::IIntentIframe",
        "items": [
            {
                "type": "function",
                "name": "get_info_by_id",
                ...
                "outputs": [
                    {
                        "type": "(core::byte_array::ByteArray, core::byte_array::ByteArray, core::byte_array::ByteArray, core::starknet::contract_address::ContractAddress)"
                    }
                ],
                "state_mutability": "view"
            },
    ...
    {
        "type": "event",
        "name": "IntentInframe::IntentInframe::IntentIframe::Event",
        "kind": "enum",
        "variants": []
    }
]